...
// work-data-updater.js
var work_data_updater_default = {
...
__name(addDeliverable, "addDeliverable");
async function updateDeliverable(data, env, corsHeaders) {
  ...
  if (updates.progress !== void 0) record.fields.Progress = updates.progress;
...
__name(updateDeliverable, "updateDeliverable");
...
__name(updateProjectProgress, "updateProjectProgress");
...
__name(markTaskComplete, "markTaskComplete");
export {
  work_data_updater_default as default
};
//# sourceMappingURL=work-data-updater.js.map
