...
udp   UNCONN 0      0             0.0.0.0:5353       0.0.0.0:*    users:(("openclaw-gatewa",pid=976,fd=27))
udp   UNCONN 0      0             0.0.0.0:5353       0.0.0.0:*    users:(("openclaw-gatewa",pid=976,fd=25))
udp   UNCONN 0      0               [::1]:323           [::]:*                                             
tcp   LISTEN 0      128           0.0.0.0:8080       0.0.0.0:*    users:(("python3",pid=3011,fd=4))        
tcp   LISTEN 0      4096       127.0.0.54:53         0.0.0.0:*                                             
tcp   LISTEN 0      4096          0.0.0.0:22         0.0.0.0:*                                             
tcp   LISTEN 0      511         127.0.0.1:18789      0.0.0.0:*    users:(("openclaw-gatewa",pid=976,fd=23))
tcp   LISTEN 0      511         127.0.0.1:18792      0.0.0.0:*    users:(("openclaw-gatewa",pid=976,fd=29))
tcp   LISTEN 0      4096    127.0.0.53%lo:53         0.0.0.0:*                                             
tcp   LISTEN 0      1000   10.255.255.254:53         0.0.0.0:*                                             
tcp   LISTEN 0      4096             [::]:22            [::]:*                                             
tcp   LISTEN 0      511             [::1]:18789         [::]:*    users:(("openclaw-gatewa",pid=976,fd=24))
```
