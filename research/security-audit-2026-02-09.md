...
udp   UNCONN 0      0             0.0.0.0:5353       0.0.0.0:*    users:(("openclaw-gatewa",pid=984,fd=27))
udp   UNCONN 0      0             0.0.0.0:5353       0.0.0.0:*    users:(("openclaw-gatewa",pid=984,fd=25))
...
tcp   LISTEN 0      511         127.0.0.1:18789      0.0.0.0:*    users:(("openclaw-gatewa",pid=984,fd=23))
tcp   LISTEN 0      511         127.0.0.1:18792      0.0.0.0:*    users:(("openclaw-gatewa",pid=984,fd=30))
tcp   LISTEN 0      1000   10.255.255.254:53         0.0.0.0:*                                             
tcp   LISTEN 0      511             [::1]:18789         [::]:*    users:(("openclaw-gatewa",pid=984,fd=24))
```
...
```
⚠️ /home/samsclaw/.openclaw/workspace/.env - Permissions 664 (should be 600)
⚠️ /home/samsclaw/.config/notion/api_key - Permissions 644 (should be 600)
```
